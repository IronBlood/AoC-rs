// Credit https://github.com/dclamage/AOC2022/blob/main/day17/src/main.rs
//        https://www.reddit.com/r/adventofcode/comments/znykq2/2022_day_17_solutions/j0k5uze/
...
fn part1(line: &str) -> String {
    let mut chamber = Chamber::new(line);
...
fn part2(line: &str) -> String {
    ...
    const INITIAL_PATTERN_SKIP_LEN: usize = 1250;
    ...
    println!("[DEBUG] pattern_len {}", found_pattern_len);
