// Credit https://github.com/ramrunner/aoc2021/blob/main/src/d17.rs
//        https://www.reddit.com/r/adventofcode/comments/ri9kdq/2021_day_17_solutions/hta9yud/
fn sum(x: i32) -> i32 {
    x * (x + 1) / 2
}
...
pub fn run(input: &str) {
    let commaind = input.find(',').unwrap();
    let xstr = &input[15..commaind];
    let ystr = &input[commaind + 4..].trim();
    let xdim = xstr
        .split("..")
